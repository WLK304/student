...
<body>
<div class="header"><h1>🏫 添加班级</h1></div>
<div class="container">
    <form action="${pageContext.request.contextPath}/ClassesServlet?action=add" method="post">
        <div class="form-group"><label>班级编号：</label><input type="text" name="classNo" required></div>
        <div class="form-group"><label>班级名称：</label><input type="text" name="className" required></div>
        ...
        <div class="form-group"><label>年级：</label><input type="text" name="grade" placeholder="如：2024"></div>
