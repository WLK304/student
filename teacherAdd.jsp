...
<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>添加教师</title>
<style>
...
<body>
<div class="header"><h1>👩‍🏫 添加教师</h1></div>
<div class="container">
    <form action="${pageContext.request.contextPath}/TeacherServlet?action=add" method="post">
        <div class="form-group"><label>教师编号：</label><input type="text" name="teacherNo" required></div>
        ...
        <div class="form-group"><label>职称：</label><input type="text" name="title" placeholder="如：教授、副教授、讲师"></div>
